...
class RegistryDayOwnerSourceTest {
    ...
    private class FakeDao : DeviceRegistryDao {
        ...
        // #771 adopt-serial surface — not exercised by this test; registry-modelled pieces mirror the
        // real table ops, the sample-table re-keys are no-ops like the delete*For stubs above.
